...
export default function Post({ post, userSession, setUpdatePosts }) {
    ...
    return (
        <div className="Post">
            <div className="postProfileInfo">
                <div className="ProfileP">
                    <div className="ProfilePicP">
                        <img src={post.userProfilePic} alt="" onClick={() => {
                            setUpdatePosts(a => !a)
            ...
            <div className="postBody">
                <p>{post.postBody}</p>
                {post.postImg ? <img src={post.postImg} alt="" /> : null}
            </div>
            ...
            <div className="LikesAndComments">
                ...
                <div className="Comments">
                    <h4>{post.postLikes.length} 0 Comments</h4>
                </div>
            </div>
